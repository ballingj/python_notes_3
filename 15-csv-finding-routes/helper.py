...
def build_parser():
    ...
    parser = argparse.ArgumentParser(
        description="Find flight paths between two airlines")
    parser.add_argument(
        'source', help="The source airport's IATA (3-letter) code.")
    parser.add_argument(
        'dest', help="The destination airport's IATA (3-letter) code.")
